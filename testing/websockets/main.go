...
var (
	...
	namespace = flag.String("namespace", "InvertingProxy", "Monitoring metric namespace")
...
func main() {
	...
	metricHandler, err := metrics.NewMetricHandler(context.Background(), *namespace, *backend, AWSConfig)
	if err != nil {
